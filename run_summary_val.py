...
data_root="D:\python project me\data\my_seq_attn_diffc/finished_files/val.bin"
...
tf.app.flags.DEFINE_string('exp_name', 'exp_logs', 'Name for experiment. Logs will be saved in a directory with this name, under log_root.')
